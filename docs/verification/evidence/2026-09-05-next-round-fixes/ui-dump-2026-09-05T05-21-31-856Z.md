...
<body>
  ...
  <main id="app" tabindex="-1"><div class="app-shell" aria-hidden="false"><section class="screen ">
    ...
    <h1 class="page-title invitations-title">邀請</h1><div class="divider-label">收到的邀請 · 0</div><div class="match-list"><div class="notice">目前沒有項目</div></div><div class="divider-label">送出的邀請 · 0</div><div class="match-list"><div class="notice">目前沒有項目</div></div><div class="divider-label">已連結 · 1</div><div class="match-list"><a class="match-card" href="/connections/undefined" data-link=""><div class="match-card-head"><h2 class="animal-persona compact">用腳尖讀懂情緒的粉色羊駝</h2><span class="status-label">已連結</span></div><p>你們都關注姿勢與張力如何承載情緒——你透過鏡頭，Ren 透過身體。</p></a></div>
  ...
  <div id="live-region" class="sr-only" aria-live="polite">Demo · Ren H. 已模擬接受</div>
