...
<body>
  ...
  <main id="app" tabindex="-1"><div class="app-shell" aria-hidden="false"><section class="screen ">
    ...
    <div class="notice success">Demo · Ren H. 已模擬接受</div>
    ...
    <div class="notice success" style="margin-bottom:18px">
      <div class="evidence"><span class="evidence-label">Demo · 模擬接受</span></div>
      <h2 style="margin:10px 0 6px">你們已連結</h2>
      <a href="mailto:ren.demo@example.com" style="overflow-wrap:anywhere">ren.demo@example.com</a>
      <div class="doc-field" style="margin-top:14px"><span class="field-label">可以這樣開場</span><p>Ren 正在低光下測試肩線提示，而你正在重寫 90 秒拍攝前說明。</p></div>
    </div>
