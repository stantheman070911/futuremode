...
ChatGPT · MEMORY
先開啟 ChatGPT 的記憶功能
開啟記憶後，ChatGPT 才能使用你已授權且實際可存取的對話與記憶，整理出更具體的介紹。
若你的帳號沒有這個功能，也可以稍後再設定；AI 仍可根據目前可用的對話內容整理介紹。
我已開啟記憶
稍後再設定
驗證碼已寄出
```
...
<body class="modal-open">
  ...
  <main id="app" tabindex="-1"><div class="app-shell" inert="" aria-hidden="true"><section class="screen no-nav">
...
陣列不得有空字串或重複項目。所有 key 與字串使用標準 JSON 雙引號，字串內雙引號必須 escape，禁止 trailing comma。輸出前自行確認標準 JSON parser 可直接解析。
  ...
  </section></div><div class="memory-modal-backdrop" data-memory-modal="">
    <section class="memory-modal" role="dialog" aria-modal="true" aria-labelledby="memory-modal-title" aria-describedby="memory-modal-description" tabindex="-1">
      <button class="memory-modal-close" data-action="dismiss-memory-notice" aria-label="關閉記憶功能教學">
        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 6l12 12M18 6L6 18"></path></svg>
      </button>
      <p class="eyebrow">ChatGPT · MEMORY</p>
      <h2 id="memory-modal-title">先開啟 ChatGPT 的記憶功能</h2>
      <p id="memory-modal-description">開啟記憶後，ChatGPT 才能使用你已授權且實際可存取的對話與記憶，整理出更具體的介紹。</p>
      <div class="memory-modal-media"><picture>
    <source media="(prefers-reduced-motion: reduce)" srcset="/assets/memory/chatgpt-enable-memory.png">
    <img src="/assets/memory/chatgpt-enable-memory.gif" alt="在 ChatGPT 開啟記憶功能的操作示範" width="600" loading="eager" decoding="async">
  </picture></div>
      <p class="memory-modal-limit">若你的帳號沒有這個功能，也可以稍後再設定；AI 仍可根據目前可用的對話內容整理介紹。</p>
      <div class="button-stack">
        <button class="button primary" data-action="confirm-memory-notice">我已開啟記憶</button>
        <button class="button quiet" data-action="dismiss-memory-notice">稍後再設定</button>
      </div>
    </section>
  </div></main>
