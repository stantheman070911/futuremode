...
function matchDetailScreen(matchId) {
  ...
  else decisionArea = `<button class="button primary" style="width:100%" data-action="match-decision" data-decision="invite" data-match-id="${esc(matchId)}">${esc(t("match.invite", { name: peerName }))}</button>`;
