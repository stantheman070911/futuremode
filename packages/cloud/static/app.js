...
function matchDetailScreen(matchId) {
  ...
  const demoMarker = runtime.demo || match.peer?.is_synthetic ? `<div class="evidence"><span class="evidence-label">${esc(t("match.demoData"))}</span></div>` : "";
