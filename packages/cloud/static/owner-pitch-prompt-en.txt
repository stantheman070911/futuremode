...
9. Treat session, event, sender, timestamp, origin, URL, and message debug metadata generated by a website or chat system as transport data, never as evidence about the owner. Never copy it into the final profile JSON.
