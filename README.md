 ...
 **AI Agent不是替人決定「你是誰」，而是幫助一個人更容易表達出，「最近在做什麼、為什麼在意某件事，最近挖掘問題深度，以及我想遇見什麼樣的人一起玩！」。**
 ...
 現在立刻使用看看我們的作品：[點這裡](https://d1vuzznd4gxltu.cloudfront.net/)
...
* PitchYourOwner 將 AI 定位成「整理者」而不是「評審」，從使用者明確授權的資料中找出反覆出現的興趣、做過的專案、思考脈絡、真實用語與最近關心的問題，再交回本人確認。這讓個人介紹從* 一次性的自我行銷，轉變成可以持續修正的「動態身份紀錄」。
...
社交節奏不同，卻能尊重彼此界線的人。
* 這是從「人物目錄」轉向「題目網絡」的過程，因為人不再是先被分類，再去努力秀魅力和尋找話題，而是先因一個值得討論或實作的題目相遇，再慢慢理解彼此有趣的樣子。
...
3. 互動風格觀察（目前尚在開發中，可以看看思考過程資料）
系統預計可以透過三種人際社交模型提供不同角度的描述：
* BFI-2：人格方向與五大特質。
